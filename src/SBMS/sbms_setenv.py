...
# programs and libraries installed there.
#
...
def mk_setenv_csh(env):
	...
	jleic_home = '%s' % env.Dir("#/..").srcnode().abspath
	...
	str += 'setenv JANA_CALIB_URL %s\n' % os.getenv('JANA_CALIB_URL', '$HOME/jleic/calib')
	...
	# JLEIC
	str += '# JLEIC\n'
	str += 'setenv JLEIC_HOME %s\n' % jleic_home
	str += 'setenv BMS_OSNAME %s\n' % env['OSNAME']
	str += 'setenv PATH ${JLEIC_HOME}/${BMS_OSNAME}/bin:${PATH}\n'
	str += 'setenv JANA_PLUGIN_PATH ${JLEIC_HOME}/${BMS_OSNAME}/plugins:${JANA_PLUGIN_PATH}\n'
	# python support
	str += 'setenv %s ${JLEIC_HOME}/${BMS_OSNAME}/lib:${%s}\n' %(LDLPV, LDLPV)
	str += 'setenv PYTHONPATH ${JLEIC_HOME}/${BMS_OSNAME}/lib/python:${PYTHONPATH}\n'
	str += '\n'
...
def mk_setenv_bash(env):
	...
	# JLEIC
	str += '# JLEIC\n'
	str += 'export JLEIC_HOME=%s\n' % jleic_home
	str += 'export BMS_OSNAME=%s\n' % env['OSNAME']
	str += 'export PATH=${JLEIC_HOME}/${BMS_OSNAME}/bin:${PATH}\n'
	str += 'export JANA_PLUGIN_PATH=${JLEIC_HOME}/${BMS_OSNAME}/plugins:${JANA_PLUGIN_PATH}\n'
	# python support
	str += 'export %s=${JLEIC_HOME}/${BMS_OSNAME}/lib:${%s}\n' %(LDLPV, LDLPV)
	str += 'export PYTHONPATH=${JLEIC_HOME}/${BMS_OSNAME}/lib/python:${PYTHONPATH}\n'
	str += '\n'
